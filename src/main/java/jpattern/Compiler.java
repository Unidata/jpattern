...
public class Compiler
{
    ...
    String compileJ(String expr) throws Error
	{return compileJ(expr,0,DEFAULTINDENTINCR);}

    String compileJ(String expr, int indent) throws Error
	{return compileJ(expr,indent,DEFAULTINDENTINCR);}

    String compileJ(String expr, int indent, int incr) throws Error
    {
	Parsetree tree = parser.parse(expr);
    ...
    Pattern compile(Parsetree n) throws Error
    {
	Pattern p = null;
	String s = null;
	...
	case ANY:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.Any(n.left.stringValue()); break;
	    case _VAR: p = Pattern.Any(n.left.varValue()); break;
	    }
	    break;
	case ARB: 
	    p = Pattern.Arb();
	...
	case BAL:
	    ...
	    case _STRING: p = Pattern.Bal(n.left.stringValue()); break;
	    case _VAR: p = Pattern.Bal(n.left.varValue()); break;
	    }
	    break;
	case BREAK:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.Break(n.left.stringValue()); break;
	    case _VAR: p = Pattern.Break(n.left.varValue()); break;
	    }
	    break;
	case BREAKX:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.BreakX(n.left.stringValue()); break;
	    case _VAR: p = Pattern.BreakX(n.left.varValue()); break;
	    }
	    break;
	case CAT:
	...
	case LEN:
	    switch (n.left.code) {
	    case _INT: p = Pattern.Len(n.left.intValue()); break;
	    case _VAR: p = Pattern.Len(n.left.varValue()); break;
	    }
	    break;
	case NOTANY:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.NotAny(n.left.stringValue()); break;
	    case _VAR: p = Pattern.NotAny(n.left.varValue()); break;
	    }
	    break;
	case NSPAN:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.NSpan(n.left.stringValue()); break;
	    case _VAR: p = Pattern.NSpan(n.left.varValue()); break;
	    }
	    break;
	case POS:
	    switch (n.left.code) {
	    case _INT: p = Pattern.Pos(n.left.intValue()); break;
	    case _VAR: p = Pattern.Pos(n.left.varValue()); break;
	    }
	    break;
	case REPLACE:
	...
	case RPOS:
	    switch (n.left.code) {
	    case _INT: p = Pattern.RPos(n.left.intValue()); break;
	    case _VAR: p = Pattern.RPos(n.left.varValue()); break;
	    }
	    break;
	case RTAB:
	    switch (n.left.code) {
	    case _INT: p = Pattern.RTab(n.left.intValue()); break;
	    case _VAR: p = Pattern.RTab(n.left.varValue()); break;
	    }
	    break;
	case SETCUR:
	...
	case SPAN:
	    switch (n.left.code) {
	    case _STRING: p = Pattern.Span(n.left.stringValue()); break;
	    case _VAR: p = Pattern.Span(n.left.varValue()); break;
	    }
	    break;
	case SUCCEED:
	    p = Pattern.Succeed();
	...
	case TAB:
	    switch (n.left.code) {
	    case _INT: p = Pattern.Tab(n.left.intValue()); break;
	    case _VAR: p = Pattern.Tab(n.left.varValue()); break;
	    }
	    break;
	...
	case JAVA:
	case _JAVASTRING:
	    throw new Error("Compiler.compile: embedded java string `...` not allowed");
	case _VAR:
    ...
    void compileJ(Parsetree n, boolean stringOK) throws Error
    {
	switch (n.code) {
