...
public class VarMap extends HashMap<String, Object>
{
    ...
    // Pure set/get
    public void put(Variable var, Object value)
    {
        super.put(var.Name, value);
    }

    public Object get(Variable var)
    {
        return super.get(var.Name);
    }

    // get/put that take ExternalVariables into account

    public Object read(Variable var)
    {
    ...
    public int getInt(Variable var)
    {
        return this.getInt(var, -1);
    }

    public int getInt(Variable var, int dfalt)
    {
        return getInt(var.Name, dfalt);
    }
    ...
    public String getString(Variable var)
    {
        return this.getString(var, null);
    }
    ...
    public Pattern getPattern(Variable var)
    {
        return getPattern(var.Name);
    }
    ...
    public void write(Variable var, Object val)
    {
        write(var.Name, val);
    }
