...
public class Main
{
    ...
    public void start()
    {
        try {
            ...
            if(Debug.level >= 1) e.printStackTrace(System.err);
            System.err.flush();
            System.exit(1);
        }
    }
        ...
        throws Exception
    {
	    ...
	    matcher.setIO(Main.stdin,Main.stdout,Main.stderr);
            if(parms.getBoolean("anchor"))
    ...
    {
        Debug.println(1, "pattern=" + p.graphToString());
